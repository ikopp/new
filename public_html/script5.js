// Fetch button texts from JSON file
	...
	// Get the modal and close button
        ...
        const arabic = 'ق ص ع ي ه ك م ح ر ل	أ';
        const fontSize = 14;
        ...
        const highlightChars1 = ['ا', 'أ', 'إ', 'ئ','ؤ', 'ء', 'ى', 'آ', 'ل', 'م', 'ر', 'ح', 'ك', 'ه', 'ي', 'ع', 'ص', 'ق'];
        ...
        const highlightChars1d = ['ا', 'أ', 'إ', 'ئ','ؤ', 'ء', 'ى', 'آ', 'ل', 'م', 'ر', 'ح', 'ك', 'ه', 'ي', 'ع', 'ص', 'ق'];
...
function analyzeText() {
    ...
    outputDiv.innerHTML = `
        <p><span style="font-size:24px; background-color:#f1c40f; color:#2c3e50">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ألر حم كهيعص ق حم&nbsp; &nbsp; &nbsp;&nbsp;</span></p>
        ${linesHtml}
        <div class="counters">
            <table id="table-7">
                <thead>
            ...
            <tr>
                ...
                <th>عدد الحروف (أ، ل، م، ر، ح، ك، ه، ي، ع، ص، ق)</th>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <tr>
                ...
                <tr>
        <th>${countSpecificChars(inputText).raa}</th>
        <th>عدد حرف (ر)</th>
    </tr>
        <tr>
        ...
        <th>عدد حرف (ح)</th>
                ...
                <tr>
        <th>${countSpecificChars(inputText).kaf}</th>
        <th>عدد حرف (ك)</th>
    </tr>
        <tr>
        ...
        <tr>
        <th>${countSpecificChars(inputText).sad}</th>
        <th>عدد حرف (ص)</th>
    </tr>
        
            <tr>
                <th id="tasnimsaid6">${countSpecificChars(inputText).paf}</th>
                <th>عدد حرف (ق)</th>
            </tr>
        </tbody>
            </table>
...
function highlightText1(text) {
    const regex = /[ا|أ|إ|ئ|ؤ|ء|ى|آ|ل|م|ح|ك|ه|ي|ع|ص|ق|ر]/g;
...
function highlightText1d(text) {
    ...
    return text.replace(regex, match => `<span class="highlight">${match}</span>`);
        ...
        function countSpecificChars(text) {
            const counts = {
                alif: 0, lam: 0, meem: 0, raa: 0, hhae: 0,
                kaf: 0, hae: 0, yaa: 0, ine: 0, sad: 0, paf: 0,
                total: 0
            };
